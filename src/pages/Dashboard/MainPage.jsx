...
const MainPage = () => {
  ...
  return (
    ...
    <div>
      ...
      <div className="flex sticky top-0 z-99 items-center justify-between bg-white dark:bg-[#292A33] shadow-4 px-8 py-4">
        ...
        <div className='flex justify-center items-center'>
            ...
            <div className="relative">
              <label
                className={`relative m-0 block h-7.5 w-14 rounded-full ${
                  colorMode === 'dark' ? 'bg-primary' : 'bg-white border-2 border-[#04BE5B]'
                }`}
              >
                <input
                  type="checkbox"
          ...
          <div className='mx-2 xl:mx-6'>
            <FaWallet className='text-[#04BE5B] text-[18px] xl:text-[28px]' />
          </div>

          <div className='mx-2 xl:mx-6'>
            <IoMdSettings className='text-[#04BE5B] text-[18px] xl:text-[28px]' />
          </div>
        </div>
      </div>
      ...
      <div className="px-6 pt-6 pb-12 dark:bg-[#292A33]">
        <div className="grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-4">
          <div className="col-span-12 dark:bg-boxdark h-[360px] rounded-[16px] bg-[#F3F3F3] shadow-6 xl:col-span-3">
          ...
          <div className="relative col-span-12 dark:bg-boxdark h-[360px] rounded-[16px] bg-[#F3F3F3] p-6 px-5 pt-7.5 pb-5 shadow-6 sm:px-7.5 xl:col-span-6">
            <img
            ...
            <div className="relative top-18 flex flex-col items-center justify-center">
              <div className="relative flex h-[200px] w-[200px] bg-white items-center justify-center shadow-6 rounded-full">
                <img
                  src="https://studentofpakistan.com/images/sop.png"
                  className="w-[100px]"
                />
              </div>
              <h1 className=" mt-3 text-[26px] font-bold dark:text-white text-black">
                Student
              </h1>
            </div>
            <a className=' cursor-pointer'>
            <BsCameraFill className='text-[#04BE5B] text-[36px] absolute top-3 left-6' />
            </a>
          </div>
              ...
              <div className="my-6 grid grid-cols-12">
                <div className="col-span-6 mx-auto flex flex-col items-center justify-center">
                  <div className="flex h-[100px] w-[100px] items-center justify-center rounded-full bg-white">
                    <img
                      src="https://cdn-icons-png.flaticon.com/512/5780/5780875.png"
                      className="mx-auto w-[80px]"
                    />
                  </div>
                  <h1 className="text-[14px] font-bold dark:text-white text-black md:text-[16px]">
                    English
                  </h1>
                </div>
                <div className="col-span-6 mx-auto flex flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-4">
          <div className="col-span-12 h-[360px] rounded-[16px] dark:bg-boxdark bg-[#F3F3F3] shadow-6 xl:col-span-3">
            <div className="rounded-t-[16px] bg-green py-6">
              <h1 className="text-center text-[16px] leading-[30px] text-white md:text-[22px]">
                Objectives
              </h1>
            ...
            <div className="p-6">
              <p className="text-[13px] font-bold text-black dark:text-white md:text-[16px]">
                Hello! i am Student of class x, Lorem Ipsum is simply dummy text
          ...
          <div className="col-span-12 h-[360px] rounded-[16px] dark:bg-boxdark bg-[#F3F3F3] shadow-6 xl:col-span-6">
            <div className="rounded-t-[16px] bg-green py-6">
              <h1 className="text-center text-[16px] leading-[30px] text-white md:text-[22px]">
                Notifications
              </h1>
        ...
        <div className="grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-4">
          <div className="col-span-12 h-auto rounded-[16px] dark:bg-boxdark bg-[#F3F3F3] shadow-6 xl:col-span-3">
            <div className="rounded-t-[16px] bg-green py-6">
              <h1 className="text-center text-[16px] leading-[30px] text-white md:text-[22px]">
          ...
          <div className="relative col-span-12 h-auto rounded-[16px] dark:bg-boxdark bg-[#F3F3F3] shadow-6 xl:col-span-6">
            <div className="rounded-t-[16px] bg-green py-6">
              <h1 className="text-center text-[18px] font-bold leading-[30px] text-white md:text-[28px]">
                RESULT ANALYSIS
              </h1>
            </div>
            <div className="p-6">
