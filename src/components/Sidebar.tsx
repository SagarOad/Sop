  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/" className="rounded-md bg-white p-2">
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <NavLink
                     ...
                     className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                       pathname.includes('mainpage') && 'bg-graydark dark:bg-meta-4'
                     }`}
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('studentregistration') &&
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/' || pathname.includes('myeducation')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                       to="#"
                       className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                         (pathname === '/myeducation' ||
                           pathname.includes('myeducation')) &&
                         'bg-graydark dark:bg-meta-4'
                       }`}
                       onClick={(e) => {
                         e.preventDefault();
